...
//#region piano-cli component
//#region @browser
@Component({
  selector: 'app-piano-cli',
  standalone: false,
  template: `hello from piano-cli<br />
...
export class PianoCliComponent {
  angularVersion =
    VERSION.full +
...
@NgModule({
  ...
  declarations: [PianoCliComponent],
})
export class PianoCliModule {}
//#endregion
//#endregion

//#region  piano-cli entity
